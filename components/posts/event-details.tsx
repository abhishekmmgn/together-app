  ...
  return (
    <div className="p-5">
      <div className="mt-2 mb-1">
        ...
        <p className="text-sm text-[#464646] line-clamp-8 md:mb-3 md:mt-1 md:text-sm+">
      ...
      <div className="my-4 space-y-2">
        <div>
          ...
          <p className="text-[#464646]">12 September, 2023</p>
        </div>
        <div>
          <h1 className="font-medium space-y-[2px]">Timings</h1>
          <p className="text-[#464646]">8am-5pm</p>
        </div>
        <div>
          <h1 className="font-medium space-y-[2px]">Location</h1>
          <p className="text-[#464646]">London</p>
        </div>
      </div>
