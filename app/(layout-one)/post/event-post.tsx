  ...
  return (
    <>
      <div className="pt-1 pb-3">
        ...
        />
        <div className={`${!props.paddingX && "px-4"} mt-2 mb-1 lg:px-0`}>
          <h2 className="font-medium md:text-base+">
            2023 TCS London Marathon US
          </h2>
          <p className="text-sm text-muted-foreground line-clamp-3 md:mb-3 md:mt-1 md:text-sm+">
        ...
        <div
          className={`${
            !props.paddingX && "px-4"
          } h-11 w-full flex items-center justify-between lg:px-0`}
        >
          <div className="flex gap-4">
            <AiOutlineLike className="text-xl text-muted-foreground" />
        ...
        <div
          className={`${
            !props. paddingX && "px-4"
          } h-8 w-full flex gap-4 items-start lg:px-0`}
        >
          <p className="text-sm text-muted-foreground">12 Likes</p>
          <p className="text-sm text-muted-foreground">18 Comments</p>
          <p className="text-sm text-muted-foreground">18 Interested</p>
        </div>
      </div>
      <Separator />
    </>
