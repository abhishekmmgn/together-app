...
export default function Navbar(props: Propstype) {
  ...
  return (
    <div className="fixed w-full z-50 top-0 inset-x-0 py-1 bg-background backdrop-filter backdrop-blur-xl bg-opacity-80 dark:bg-background dark:bg-opacity-0 dark:backdrop-blur-0 border-b">
      ...
      <div className="h-[34px] flex items-start justify-evenly px-5 pt-1 gap-1 sm:hidden">
