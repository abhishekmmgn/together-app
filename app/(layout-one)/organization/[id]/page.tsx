...
import OrgCard from "@/components/explore/profile-card";
    ...
    <div>
      ...
      <div className="px-5">
        <div className="py-4 space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground line-clamp-6">
              ...
              DKMS, our German predecessor, we were founded in 2004 in the U.S.
              as DKMS Americas, and since renamed DKMS. With the firm belief
              that people everywhere can play an active role in saving the lives
              of others with blood cancers and blood and bone marrow disorders,
              our mission is to grow the number of suitable bone marrow and
              blood stem cell donors for patients in need of a
            </p>
          </div>
          <div>
        ...
        <div className="py-6 space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <h1 className="font-medium text-2xl">Similar Organizations</h1>
              <Link href="/explore">
                <p className="text-primary text-sm">See All</p>
              </Link>
            </div>
