...
import { IoMenuOutline as PanelLeftIcon } from "react-icons/io5";

const SIDEBAR_COOKIE_NAME = "sidebar_state";
const SIDEBAR_COOKIE_MAX_AGE = 60 * 60 * 24 * 7;
const SIDEBAR_WIDTH = "var(--sidebar-width-custom)";
